...
* [Usage](#Usage)
   ...
   * [How to Run a Native Hadoop Cluster? Step by Step](#How-to-Run-a-Native-Hadoop-Cluster?-Step-by-Step)
...
<!---
[Example of How to Set the Cluster Conf Files (hdfs-site.xml, core-site.xml, mapred-site.xml, and yarn-site.xml)](#Example-of-How-to Set-the-Cluster-Conf-Files-(hdfs-site.xml,-core-site.xml,-mapred-site.xml,-and yarn-site.xml)) )
* [How to Run a Job With and Without _Network Awareness_](#How-to-Run-a-Job-With-and-Without-_Network-Awareness_))
-->
...
+ jobHistory - 
   ...
   + `HadoopJobStatistics3.nb` and .xlsx files  for making figures.
...
### How to Run a Native Hadoop Cluster? Step by Step
...
![Image](http://https://github.com/razo7/Nap/Security_Group_Example.jpg)

#### Example of How to Set the Cluster Conf Files (hdfs-site.xml, core-site.xml, mapred-site.xml, and yarn-site.xml)
1. hdfs-site.xml
```
<configuration>
    <property>
...
### How to Run a Job With and Without _Network Awareness_?
...
Run JobHistory server `HADOOP_HOME/sbin/mr-jobhistory-daemon.sh start historyserver` and define it also in yarn-site.xml then you can http to http://MASTER_IP_ADDRESS:19888 (check AWS connectivity, group policies) and see the all the informartion regarding all the jobs for the curren runnig cluster, for example the counters ![Image](http://https://github.com/razo7/Nap/jobHistory/JobHistory_Counters_Example.PNG)
...
## Contact
Created by Or Raz (razo7) as part of the master's thesis work and [@article](IEEE.com) - feel free to contact me on Linkedin [@Or Raz]<https://www.linkedin.com/in/or-raz/> or razo@post.bgu.ac.il !
